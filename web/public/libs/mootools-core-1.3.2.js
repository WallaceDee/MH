;(function () {
  ...
  Type.isEnumerable = function (item) {
    return (
      item != null && typeof item.length == 'number' && toString.call(item) != '[object Function]'
    )
  }
  var hooks = {}
  ...
  this.$each = function (iterable, fn, bind) {
    ...
    ;(type == 'arguments' || type == 'collection' || type == 'array' || type == 'elements'
      ? Array
      : Object
...
Array.implement({
  ...
  flatten: function () {
    ...
    for (var i = 0, l = this.length; i < l; i++) {
      ...
      array = array.concat(
        type == 'array' || type == 'collection' || type == 'arguments' || instanceOf(this[i], Array)
...
;(function () {
  ...
  var platform = ua.match(/ip(?:ad|od|hone)/)
    ? 'ios'
...
var $$OriginEvent = window.Event
var Event = new Type('Event', function (event, win) {
  if (typeof event === 'string' && $$OriginEvent) {
    return new $$OriginEvent(event)
  }
  if (!win) win = window
...
;(function () {
  ...
  local.setDocument = function (document) {
    ...
    if (features.isHTMLDocument) {
      ...
      features.nativeMatchesSelector =
        root.matchesSelector || root.mozMatchesSelector || root.webkitMatchesSelector
...
;(function () {
  ...
  var map = {
    ...
    focus: { base: 'focus' + (eventListenerSupport ? '' : 'in'), capture: true },
    blur: { base: eventListenerSupport ? 'blur' : 'focusout', capture: true }
  }
  var _key = '$delegation:'
  ...
  var Asset = (this.Asset = {
    ...
    images: function (sources, options) {
      ...
      options = Object.merge(
        { onComplete: fn, onProgress: fn, onError: fn, properties: {} },
        options
      )
      return new Elements(
...
;(function (win) {
  ...
  Element.implement({
    ...
    $width: function (width) {
      ...
      ;['padding-left', 'padding-right', 'border-left-width', 'border-right-width'].each(function (
        attr
      ) {
    ...
    $height: function (height) {
      ...
      ;['padding-top', 'padding-bottom', 'border-top-width', 'border-bottom-width'].each(function (
        attr
      ) {
        var value = parseInt(ctx.getStyle(attr))
  ...
  ;(function () {
    ...
    function Animate(elem, options) {
      ...
      ctx.fn =
        options.fn ||
        function (result, currentTime, beginValue, distanceValue, totalTime) {
...
;(function () {
  ...
  var AjaxConstants = { Failed: 0, Ok: 1, Error: 2 }
  ...
  Request.JSON = new Class({
    ...
    initialize: function (options) {
      ...
      this.addEvent('error', function (text, error) {
        try {
          ...
          sendLog({ msg: 'JSON_REQUEST_PARSE', info: info, target: this.options.url })
        } catch (e) {}
      })
    },
    onSuccess: function (json, text) {
      try {
        if (json.status == AjaxConstants.Error) {
          sendLog({ msg: 'JSON_RESPONSE_ERROR', info: text, target: this.options.url })
        }
      } catch (e) {}
    ...
    onFailure: function (xhr) {
      try {
        if (this.status !== 0) {
          sendLog({ msg: 'JSON_REQUEST_FAILED', info: this.status, target: this.options.url })
        }
      } catch (e) {}
      if (this.status !== 0) {
        watch(this.parent, arguments).call(this)
    ...
    onException: function (headerName, value) {
      try {
        sendLog({ msg: 'JSON_REQUEST_EXCEPTION', info: this.status, target: this.options.url })
      } catch (e) {}
      watch(this.parent, arguments).call(this)
    },
    onTimeout: function () {
      try {
        sendLog({ msg: 'JSON_REQUEST_TIMEOUT', info: this.status, target: this.options.url })
      } catch (e) {}
      watch(this.parent, arguments).call(this)
    }
  })
...
!(function () {
  var e =
      'object' == typeof exports && null !== exports && 'number' != typeof exports.nodeType
        ? exports
  ...
  ;((f.prototype = new Error()).name = 'InvalidCharacterError'),
    ...
    e.atob ||
      (e.atob = function (e) {
        ...
        if (t.length % 4 == 1)
          throw new f("'atob' failed: The string to be decoded is not correctly encoded.")
        for (
          var r, o, n = 0, a = 0, i = '';
          (o = t.charAt(a++));
  ...
  ;(function () {
    ...
    Array.from = (function () {
      ...
      return function from(arrayLike) {
        if (arguments.length === 1) {
          return Array.convert.apply(this, arguments)
        }
        var C = this
