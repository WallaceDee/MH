...
/* harmony import */ var _SimilarRoleTable_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SimilarRoleTable.vue */ "./src/components/SimilarRoleTable.vue");
...
/* harmony import */ var _RoleInfo_RoleImage_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RoleInfo/RoleImage.vue */ "./src/components/RoleInfo/RoleImage.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SimilarRoleTable: _SimilarRoleTable_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    RoleImage: _RoleInfo_RoleImage_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  mixins: [_utils_mixins_commonMixin__WEBPACK_IMPORTED_MODULE_4__.commonMixin],
  props: {
    role: {
      type: Object,
      required: true
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("重连")]) : _vm._e(), _vm._v(" "), !_vm.isInNewWindow ? _c("a", {
    ...
    return _c("div", {
      ...
      on: {
        click: function ($event) {
          return _vm.toggleResponse(index);
        }
      }
    }, [_vm._v("\n            " + _vm._s(_vm.expandedItems.includes(index) ? "收起" : "展开") + "响应数据\n          ")]), _vm._v(" "), _vm.expandedItems.includes(index) ? _c("div", {
      staticClass: "response-content"
    }, [_c("pre", [_vm._v(_vm._s(JSON.stringify(item.responseData, null, 2)))])]) : _vm._e()], 1) : _vm._e()]);
  }), 0)], 1)]);
};
var staticRenderFns = [];
...
var render = function render() {
  ...
  }, [_vm._v(" "), _vm.visible ? _c("div", [_vm.similarData ? _c("div", [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.confidenceLevel))])]), _vm._v(" "), _c("span", [_vm._v("锚点数: " + _vm._s(_vm.similarData?.anchor_count || "-"))])])], 1), _vm._v(" "), _vm.similarData.statistics ? _c("div", {
    staticClass: "stats"
  }, [_c("span", [_vm._v("\n            价格范围:\n            "), _c("span", {
    domProps: {
  ...
  })]), _vm._v(" "), _c("span", [_vm._v("平均相似度: " + _vm._s(_vm.similarData.statistics.similarity_range.avg.toFixed(3)))])]) : _vm._e()]), _vm._v(" "), _vm.similarData.anchors?.length ? _c("similar-role-table", {
    attrs: {
  ...
  return _c("el-table", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function (scope) {
        ...
        }, [_vm._v("\n            " + _vm._s(scope.row.expt_ski1 || 0) + "/" + _vm._s(scope.row.expt_ski2 || 0) + "/" + _vm._s(scope.row.expt_ski3 || 0) + "/" + _vm._s(scope.row.expt_ski4 || 0) + "\n          ")])]), _vm._v(" "), _c("div", {
          staticClass: "cultivation-row"
        }, [_c("span", {
          staticClass: "cultivation-values"
        }, [_vm._v("\n            " + _vm._s(scope.row.beast_ski1 || 0) + "/" + _vm._s(scope.row.beast_ski2 || 0) + "/" + _vm._s(scope.row.beast_ski3 || 0) + "/" + _vm._s(scope.row.beast_ski4 || 0) + "\n          ")])]), _vm._v(" "), scope.row.total_cultivation ? _c("div", {
          staticClass: "cultivation-row"
        }, [_c("span", {
